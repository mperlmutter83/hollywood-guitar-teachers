  ...
  return (
    <footer className="bg-indigo-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-8">
        ...
        <div><h4 className="font-bold mb-4">Contact</h4><a href="tel:+18188736719" className="text-amber-400">(818) 873-6719</a><p className="text-gray-300 mt-2">info@hollywoodguitarteachers.com</p><p className="text-gray-300">Los Angeles, CA</p></div>
